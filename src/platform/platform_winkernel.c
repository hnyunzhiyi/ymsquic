    ...
    )
{
    ...
    QuicTraceLogInfo("WindowsKernelLoaded: [sys] Loaded");
}
    ...
    )
{
    ...
    QuicTraceLogInfo("WindowsKernelUnloaded: [sys] Unloaded");
    ...
    )
{
    ...
    QuicTraceLogInfo(
        "WindowsKernelInitialized: [sys] Initialized (PageSize = %u bytes; AvailMem = %llu bytes)",
        Sbi.PageSize,
        QuicTotalMemory);
    ...
    )
{
    ...
    BCryptCloseAlgorithmProvider(QuicPlatform.RngAlgorithm, 0);
    QuicPlatform.RngAlgorithm = NULL;
    QuicTraceLogInfo("WindowsKernelUninitialized: [sys] Uninitialized");
}
