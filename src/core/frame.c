    ...
    )
{
    ...
    QUIC_DBG_ASSERT(Frame->IgnoreOrder <= 1); // IgnoreOrder should only be 0 or 1.
    ...
    )
{
    ...
    *Offset += 1;
    ...
    case QUIC_FRAME_PADDING: {
        ...
        QuicTraceLogVerbose(
            "FrameLogPadding: [%c][%cX][%lu]   PADDING Len:%hu",
            PtkConnPre(Connection),
            PktRxPre(Rx),
            PacketNumber,
            (*Offset - Start) + 1);
    ...
    case QUIC_FRAME_ACK_1: {
        ...
        if (!QuicAckHeaderDecode(PacketLength, Packet, Offset, &Frame)) {
            QuicTraceLogVerbose(
                "FrameLogAckInvalid: [%c][%cX][%lu]   ACK [Invalid]",
                PtkConnPre(Connection),
                PktRxPre(Rx),
                PacketNumber);
            return FALSE;
        ...
        QuicTraceLogVerbose(
            "FrameLogAck: [%c][%cX][%lu]   ACK Largest:%lu Delay:%lu",
            PtkConnPre(Connection),
            PktRxPre(Rx),
            PacketNumber,
        ...
        if (Frame.FirstAckBlock == 0) {
            QuicTraceLogVerbose(
                "FrameLogAckSingleBlock: [%c][%cX][%lu]     %lu",
                PtkConnPre(Connection),
                PktRxPre(Rx),
                PacketNumber,
                Frame.LargestAcknowledged);
            ...
            QuicTraceLogVerbose(
                "FrameLogAckMultiBlock: [%c][%cX][%lu]     %lu - %lu",
                PtkConnPre(Connection),
                PktRxPre(Rx),
                PacketNumber,
        ...
        for (uint64_t i = 0; i < Frame.AdditionalAckBlockCount; i++) {
            ...
            if (!QuicAckBlockDecode(PacketLength, Packet, Offset, &Block)) {
                QuicTraceLogVerbose(
                    "FrameLogAckInvalidBlock: [%c][%cX][%lu]     [Invalid Block]",
                    PtkConnPre(Connection),
                    PktRxPre(Rx),
                    PacketNumber);
                return FALSE;
        ...
        if (FrameType == QUIC_FRAME_ACK_1) {
            ...
            if (!QuicVarIntDecode(PacketLength, Packet, Offset, &Ecn.ECT_0_Count) ||
                ...
                QuicTraceLogVerbose(
                    "FrameLogAckEcnInvalid: [%c][%cX][%lu]     ECN [Invalid]",
                    PtkConnPre(Connection),
                    PktRxPre(Rx),
                    PacketNumber);
                return FALSE;
            ...
            QuicTraceLogVerbose(
                "FrameLogAckEcn: [%c][%cX][%lu]     ECN [ECT0=%lu,ECT1=%lu,CE=%lu]",
                PtkConnPre(Connection),
                PktRxPre(Rx),
                PacketNumber,
                Ecn.ECT_0_Count,
    ...
    case QUIC_FRAME_RESET_STREAM: {
        ...
        if (!QuicResetStreamFrameDecode(PacketLength, Packet, Offset, &Frame)) {
            QuicTraceLogVerbose(
                "FrameLogResetStreamInvalid: [%c][%cX][%lu]   RESET_STREAM [Invalid]",
                PtkConnPre(Connection),
                PktRxPre(Rx),
                PacketNumber);
            return FALSE;
        ...
        QuicTraceLogVerbose(
            "FrameLogResetStream: [%c][%cX][%lu]   RESET_STREAM ID:%lu ErrorCode:0x%lX FinalSize:%lu",
            PtkConnPre(Connection),
            PktRxPre(Rx),
            PacketNumber,
            Frame.StreamID,
    ...
    case QUIC_FRAME_STOP_SENDING: {
        ...
        if (!QuicStopSendingFrameDecode(PacketLength, Packet, Offset, &Frame)) {
            QuicTraceLogVerbose(
                "FrameLogStopSendingInvalid: [%c][%cX][%lu]   STOP_SENDING [Invalid]",
                PtkConnPre(Connection),
                PktRxPre(Rx),
                PacketNumber);
            return FALSE;
        ...
        QuicTraceLogVerbose(
            "FrameLogStopSending: [%c][%cX][%lu]   STOP_SENDING ID:%lu Error:0x%lX",
            PtkConnPre(Connection),
            PktRxPre(Rx),
            PacketNumber,
            Frame.StreamID,
    ...
    case QUIC_FRAME_CRYPTO: {
        ...
        if (!QuicCryptoFrameDecode(PacketLength, Packet, Offset, &Frame)) {
            QuicTraceLogVerbose(
                "FrameLogCryptoInvalid: [%c][%cX][%lu]   CRYPTO [Invalid]",
                PtkConnPre(Connection),
                PktRxPre(Rx),
                PacketNumber);
            return FALSE;
        ...
        QuicTraceLogVerbose(
            "FrameLogCrypto: [%c][%cX][%lu]   CRYPTO Offset:%lu Len:%hu",
            PtkConnPre(Connection),
            PktRxPre(Rx),
            PacketNumber,
            Frame.Offset,
    ...
    case QUIC_FRAME_NEW_TOKEN: {
        ...
        if (!QuicNewTokenFrameDecode(PacketLength, Packet, Offset, &Frame)) {
            QuicTraceLogVerbose(
                "FrameLogNewTokenInvalid: [%c][%cX][%lu]   NEW_TOKEN [Invalid]",
                PtkConnPre(Connection),
                PktRxPre(Rx),
                PacketNumber);
            return FALSE;
        ...
        QuicTraceLogVerbose(
            "FrameLogNewToken: [%c][%cX][%lu]   NEW_TOKEN Length:%lu",
            PtkConnPre(Connection),
            PktRxPre(Rx),
            PacketNumber,
            Frame.TokenLength);
    ...
    case QUIC_FRAME_STREAM_7: {
        ...
        if (!QuicStreamFrameDecode(FrameType, PacketLength, Packet, Offset, &Frame)) {
            QuicTraceLogVerbose(
                "FrameLogStreamInvalid: [%c][%cX][%lu]   STREAM [Invalid]",
                PtkConnPre(Connection),
                PktRxPre(Rx),
                PacketNumber);
            return FALSE;
        ...
        if (Frame.Fin) {
            QuicTraceLogVerbose(
                "FrameLogStreamFin: [%c][%cX][%lu]   STREAM ID:%lu Offset:%lu Len:%hu Fin",
                PtkConnPre(Connection),
                PktRxPre(Rx),
                PacketNumber,
                Frame.StreamID,
            ...
            QuicTraceLogVerbose(
                "FrameLogStream: [%c][%cX][%lu]   STREAM ID:%lu Offset:%lu Len:%hu",
                PtkConnPre(Connection),
                PktRxPre(Rx),
                PacketNumber,
                Frame.StreamID,
    ...
    case QUIC_FRAME_MAX_DATA: {
        ...
        if (!QuicMaxDataFrameDecode(PacketLength, Packet, Offset, &Frame)) {
            QuicTraceLogVerbose(
                "FrameLogMaxDataInvalid: [%c][%cX][%lu]   MAX_DATA [Invalid]",
                PtkConnPre(Connection),
                PktRxPre(Rx),
                PacketNumber);
            return FALSE;
        ...
        QuicTraceLogVerbose(
            "FrameLogMaxData: [%c][%cX][%lu]   MAX_DATA Max:%lu",
            PtkConnPre(Connection),
            PktRxPre(Rx),
            PacketNumber,
            Frame.MaximumData);
    ...
    case QUIC_FRAME_MAX_STREAM_DATA: {
        ...
        if (!QuicMaxStreamDataFrameDecode(PacketLength, Packet, Offset, &Frame)) {
            QuicTraceLogVerbose(
                "FrameLogMaxStreamDataInvalid: [%c][%cX][%lu]   MAX_STREAM_DATA [Invalid]",
                PtkConnPre(Connection),
                PktRxPre(Rx),
                PacketNumber);
            return FALSE;
        ...
        QuicTraceLogVerbose(
            "FrameLogMaxStreamData: [%c][%cX][%lu]   MAX_STREAM_DATA ID:%lu Max:%lu",
            PtkConnPre(Connection),
            PktRxPre(Rx),
            PacketNumber,
            Frame.StreamID,
    ...
    case QUIC_FRAME_MAX_STREAMS_1: {
        ...
        if (!QuicMaxStreamsFrameDecode(FrameType, PacketLength, Packet, Offset, &Frame)) {
            QuicTraceLogVerbose(
                "FrameLogMaxStreamsInvalid: [%c][%cX][%lu]   MAX_STREAMS [Invalid]",
                PtkConnPre(Connection),
                PktRxPre(Rx),
                PacketNumber);
            return FALSE;
        ...
        QuicTraceLogVerbose(
            "FrameLogMaxStreams: [%c][%cX][%lu]   MAX_STREAMS[%hu] Count:%lu",
            PtkConnPre(Connection),
            PktRxPre(Rx),
            PacketNumber,
            Frame.BidirectionalStreams,
    ...
    case QUIC_FRAME_DATA_BLOCKED: {
        ...
        if (!QuicDataBlockedFrameDecode(PacketLength, Packet, Offset, &Frame)) {
            QuicTraceLogVerbose(
                "FrameLogDataBlockedInvalid: [%c][%cX][%lu]   DATA_BLOCKED [Invalid]",
                PtkConnPre(Connection),
                PktRxPre(Rx),
                PacketNumber);
            return FALSE;
        ...
        QuicTraceLogVerbose(
            "FrameLogDataBlocked: [%c][%cX][%lu]   DATA_BLOCKED Limit:%lu",
            PtkConnPre(Connection),
            PktRxPre(Rx),
            PacketNumber,
            Frame.DataLimit);
    ...
    case QUIC_FRAME_STREAM_DATA_BLOCKED: {
        ...
        if (!QuicStreamDataBlockedFrameDecode(PacketLength, Packet, Offset, &Frame)) {
            QuicTraceLogVerbose(
                "FrameLogStreamDataBlockedInvalid: [%c][%cX][%lu]   STREAM_DATA_BLOCKED [Invalid]",
                PtkConnPre(Connection),
                PktRxPre(Rx),
                PacketNumber);
            return FALSE;
        ...
        QuicTraceLogVerbose(
            "FrameLogStreamDataBlocked: [%c][%cX][%lu]   STREAM_DATA_BLOCKED ID:%lu Limit:%lu",
            PtkConnPre(Connection),
            PktRxPre(Rx),
            PacketNumber,
            Frame.StreamID,
    ...
    case QUIC_FRAME_STREAMS_BLOCKED_1: {
        ...
        if (!QuicStreamsBlockedFrameDecode(FrameType, PacketLength, Packet, Offset, &Frame)) {
            QuicTraceLogVerbose(
                "FrameLogStreamsBlockedInvalid: [%c][%cX][%lu]   STREAMS_BLOCKED [Invalid]",
                PtkConnPre(Connection),
                PktRxPre(Rx),
                PacketNumber);
            return FALSE;
        ...
        QuicTraceLogVerbose(
            "FrameLogStreamsBlocked: [%c][%cX][%lu]   STREAMS_BLOCKED[%hu] ID:%lu",
            PtkConnPre(Connection),
            PktRxPre(Rx),
            PacketNumber,
            Frame.BidirectionalStreams,
    ...
    case QUIC_FRAME_NEW_CONNECTION_ID: {
        ...
        if (!QuicNewConnectionIDFrameDecode(PacketLength, Packet, Offset, &Frame)) {
            QuicTraceLogVerbose(
                "FrameLogNewConnectionIDInvalid: [%c][%cX][%lu]   NEW_CONN_ID [Invalid]",
                PtkConnPre(Connection),
                PktRxPre(Rx),
                PacketNumber);
            return FALSE;
        ...
        QuicTraceLogVerbose(
            "FrameLogNewConnectionID: [%c][%cX][%lu]   NEW_CONN_ID Seq:%lu RPT:%lu CID:%s Token:%s",
            PtkConnPre(Connection),
            PktRxPre(Rx),
            PacketNumber,
            Frame.Sequence,
    ...
    case QUIC_FRAME_RETIRE_CONNECTION_ID: {
        ...
        if (!QuicRetireConnectionIDFrameDecode(PacketLength, Packet, Offset, &Frame)) {
            QuicTraceLogVerbose(
                "FrameLogRetireConnectionIDInvalid: [%c][%cX][%lu]   RETIRE_CONN_ID [Invalid]",
                PtkConnPre(Connection),
                PktRxPre(Rx),
                PacketNumber);
            return FALSE;
        ...
        QuicTraceLogVerbose(
            "FrameLogRetireConnectionID: [%c][%cX][%lu]   RETIRE_CONN_ID Seq:%lu",
            PtkConnPre(Connection),
            PktRxPre(Rx),
            PacketNumber,
            Frame.Sequence);
    ...
    case QUIC_FRAME_PATH_CHALLENGE: {
        ...
        if (!QuicPathChallengeFrameDecode(PacketLength, Packet, Offset, &Frame)) {
            QuicTraceLogVerbose(
                "FrameLogPathChallengeInvalid: [%c][%cX][%lu]   PATH_CHALLENGE [Invalid]",
                PtkConnPre(Connection),
                PktRxPre(Rx),
                PacketNumber);
            return FALSE;
        ...
        QuicTraceLogVerbose(
            "FrameLogPathChallenge: [%c][%cX][%lu]   PATH_CHALLENGE [%lu]",
            PtkConnPre(Connection),
            PktRxPre(Rx),
            PacketNumber,
    ...
    case QUIC_FRAME_PATH_RESPONSE: {
        ...
        if (!QuicPathChallengeFrameDecode(PacketLength, Packet, Offset, &Frame)) {
            QuicTraceLogVerbose(
                "FrameLogPathResponseInvalid: [%c][%cX][%lu]   PATH_RESPONSE [Invalid]",
                PtkConnPre(Connection),
                PktRxPre(Rx),
                PacketNumber);
            return FALSE;
        ...
        QuicTraceLogVerbose(
            "FrameLogPathResponse: [%c][%cX][%lu]   PATH_RESPONSE [%lu]",
            PtkConnPre(Connection),
            PktRxPre(Rx),
            PacketNumber,
            QuicByteSwapUint64(*(uint64_t*)Frame.Data));
    ...
    case QUIC_FRAME_CONNECTION_CLOSE_1: {
        ...
        if (!QuicConnCloseFrameDecode(FrameType, PacketLength, Packet, Offset, &Frame)) {
            QuicTraceLogVerbose(
                "FrameLogConnectionCloseInvalid: [%c][%cX][%lu]   CONN_CLOSE [Invalid]",
                PtkConnPre(Connection),
                PktRxPre(Rx),
                PacketNumber);
            return FALSE;
        ...
        if (Frame.ApplicationClosed) {
            QuicTraceLogVerbose(
                "FrameLogConnectionCloseApp: [%c][%cX][%lu]   CONN_CLOSE (App) ErrorCode:0x%lX",
                PtkConnPre(Connection),
                PktRxPre(Rx),
                PacketNumber,
                Frame.ErrorCode);
            ...
            QuicTraceLogVerbose(
                "FrameLogConnectionClose: [%c][%cX][%lu]   CONN_CLOSE ErrorCode:0x%lX FrameType:%lu",
                PtkConnPre(Connection),
                PktRxPre(Rx),
                PacketNumber,
                Frame.ErrorCode,
    ...
    case QUIC_FRAME_HANDSHAKE_DONE: {
        QuicTraceLogVerbose(
            "FrameLogHandshakeDone: [%c][%cX][%lu]   HANDSHAKE_DONE",
            PtkConnPre(Connection),
            PktRxPre(Rx),
            PacketNumber);
        break;
    ...
    case QUIC_FRAME_DATAGRAM_1: {
        ...
        if (!QuicDatagramFrameDecode(FrameType, PacketLength, Packet, Offset, &Frame)) {
            QuicTraceLogVerbose(
                "FrameLogDatagramInvalid: [%c][%cX][%lu]   DATAGRAM [Invalid]",
                PtkConnPre(Connection),
                PktRxPre(Rx),
                PacketNumber);
            return FALSE;
        ...
        QuicTraceLogVerbose(
            "FrameLogDatagram: [%c][%cX][%lu]   DATAGRAM Len:%hu",
            PtkConnPre(Connection),
            PktRxPre(Rx),
            PacketNumber,
            (uint16_t)Frame.Length);
    ...
    case QUIC_FRAME_ACK_FREQUENCY: {
        ...
        QuicTraceLogVerbose(
            "[%c][%cX][%lu]   ACK_FREQUENCY SeqNum:%lu PktTolerance:%lu MaxAckDelay:%lu IgnoreOrder:%hhu",
            PtkConnPre(Connection),
            PktRxPre(Rx),
            PacketNumber,
